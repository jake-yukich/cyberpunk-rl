...
# Full deck of all opportunity cards
OPPORTUNITIES_DECK = [
    # Braindance Deals
    CORPORATE_ELITE_BD, ORGANITSKAYA_BD, PREEM_BD, REALITY_JUNKIE_REQUEST,
    RIPPERDOC_BD, SPIKED_BD, SYNTHCOKE_DEAL, UPSCALE_VRCADE, XBD_DEALER,
    # Cyberware Deals  
    BACK_ALLEY_RIPPERDOC, BODYSHOPPE_CYBERTUNING, CHIPPIN_IN, CORP_WARE_AUGMENTATIONS,
    CYBERED_UP, CYBERFASHION_UPGRADES, NIGHT_MARKET_TUNE_UP, PREEM_CYBERWARE,
    RONIN_UPGRADES,
    # Weapon Deals
    ARMING_THE_CITY, BOOTLEG_ARASAKA_TECH, BUDGET_ARMS_DISPOSABLES,
    CORP_PROTOTYPES, IRON_TO_THE_MASSES, MILITECH_SMART_GUNS, NOKOTA_WEAPONS_SHIPMENT,
    SMUGGLING_OPERATION, UNPREDICTABLE_SMART_GUN,
    # Special
    ARASAKA_BLUEPRINTS
]
